...
import imgr1 from './photos/ristorante/1.webp'
import imgp from './photos/ristorante/5.webp'
import img4 from './photos/ristorante/7.webp'
...
const MenuPage = () => (
  <div>
    ...
    <div className='mw6-l center pl5 pr4'>
      ...
      <img
        className='db absolute-l right-0-l w-50-m w-25-l fl-m pl3-m mt3-l mb3-m'
        src={img4} />
      <p className='f6 mb5'>
